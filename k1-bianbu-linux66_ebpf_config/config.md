...
#
CONFIG_CC_VERSION_TEXT="riscv64-unknown-linux-gnu-gcc (g04696df0963) 14.2.0"
CONFIG_CC_IS_GCC=y
...
CONFIG_RISCV_ISA_ZBS=y
CONFIG_RISCV_ISA_ZICBOM=y
CONFIG_RISCV_ISA_ZICBOZ=y
CONFIG_RISCV_ISA_ZICOND=y
...
# CONFIG_AIC_IRQ_ACTIVE_UNSET is not set
...
CONFIG_CHSC5XXX_TOUCHPANEL_DRIVER=y
CONFIG_SEMI_TOUCH_AUTO_UPDATE_EN=y
# CONFIG_SEMI_TOUCH_APK_NODE_EN is not set
...
CONFIG_DRM_LT9711=y
CONFIG_DRM_RASPBERRYPI_TOUCHSCREEN=y
# CONFIG_POWERVR_ROGUE_NULLDRMDISP is not set
CONFIG_POWERVR_ROGUE=y
# CONFIG_POWERVR_DVFS is not set
